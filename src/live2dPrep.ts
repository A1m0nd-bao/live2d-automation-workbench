...
使用均匀干净的棚拍光与不透明极浅灰纯背景。不要透明棋盘格、场景、地面阴影、文字、水印、边框、拼贴、重复角色或额外道具。避免身份漂移、服装改变、配饰缺失、肢体裁切、断肢、额外或缺失的手指/肢体、肢体粘连、重叠错误、强透视、戏剧性姿势、动态模糊和风格替换。这是中立拆分源图，不是已经绑定的 Live2D 模型。`;
}
